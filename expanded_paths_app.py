...
st.title("FQHC Executive Roles Scraper (Expanded Paths)")
st.markdown(
    """
    Upload a CSV of organizations (columns: 'Name' and optional 'Website').
    The app will visit key pages, including extra paths, 
...
# Expanded list of paths including the new leadership path
paths = [
...
st.download_button(
    ...
    data=buffer,
    file_name="expanded_paths_executives.xlsx",
